...
val DUMMY_NOTARY: Party get() = Party(CordaX500Name("Notary Service", "Zurich", "CH"), DUMMY_NOTARY_KEY.public)
...
val DUMMY_MAP: Party get() = Party(CordaX500Name("Network Map Service", "Amsterdam", "NL"), DUMMY_MAP_KEY.public)

val DUMMY_BANK_A_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(40)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_A: Party get() = Party(CordaX500Name("Bank A", "London", "GB"), DUMMY_BANK_A_KEY.public)

val DUMMY_BANK_B_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(50)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_B: Party get() = Party(CordaX500Name("Bank B", "New York", "US"), DUMMY_BANK_B_KEY.public)

val DUMMY_BANK_C_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(60)) }
/** Dummy bank identity for tests and simulations */
val DUMMY_BANK_C: Party get() = Party(CordaX500Name("Bank C", "Tokyo", "JP"), DUMMY_BANK_C_KEY.public)
...
val ALICE: Party get() = Party(CordaX500Name("Alice Corp", "Madrid", "ES"), ALICE_KEY.public)
...
val BOB: Party get() = Party(CordaX500Name("Bob Plc", "Rome", "IT"), BOB_KEY.public)
...
val CHARLIE: Party get() = Party(CordaX500Name("Charlie Ltd", "Athens", "GR"), CHARLIE_KEY.public)

val DUMMY_REGULATOR_KEY: KeyPair by lazy { entropyToKeyPair(BigInteger.valueOf(100)) }
/** Dummy regulator for tests and simulations */
val DUMMY_REGULATOR: Party get() = Party(CordaX500Name("Regulator A", "Paris", "FR"), DUMMY_REGULATOR_KEY.public)
...
val DUMMY_PARTY: Party get() = Party(CordaX500Name("Dummy", "Madrid", "ES"), DUMMY_KEY_1.public)
