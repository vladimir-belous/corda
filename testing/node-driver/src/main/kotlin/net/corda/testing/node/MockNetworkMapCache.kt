...
class MockNetworkMapCache(database: CordaPersistence, configuration: NodeSSLConfiguration) : PersistentNetworkMapCache(database, configuration) {
    private companion object {
        val BANK_C = getTestPartyAndCertificate(CordaX500Name("Bank C", "London", "GB"), entropyToKeyPair(BigInteger.valueOf(1000)).public)
        val BANK_D = getTestPartyAndCertificate(CordaX500Name("Bank D", "London", "GB"), entropyToKeyPair(BigInteger.valueOf(2000)).public)
